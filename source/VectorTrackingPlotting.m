classdef VectorTrackingPlotting < handle
    ...
    methods
        ...
        function plotMap(obj)
            rcvrLLA = flat2lla(obj.outputs.rcvrStates(~isnan(obj.outputs.rcvrStates(:,7)),7:9),[obj.outputs.trueLAT(1) obj.outputs.trueLONG(1)],0,0,'WGS84');
            ...
            geoplot(obj.outputs.trueLAT,obj.outputs.trueLONG,'LineWidth',obj.lw,'Color','k')
        ...
        function plotStates(obj)
            ...
            ylabel('North [m/s]')
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,1),'LineWidth',obj.lw,'Color',obj.primaryColor)
            ...
            hold on
            ylabel('East [m/s]')
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,2),'LineWidth',obj.lw,'Color',obj.primaryColor)
            ...
            ylabel('Down [m/s]')
            xlabel('Time [s]')
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,3),'LineWidth',obj.lw,'Color',obj.primaryColor)
            ...
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,4)*R2D,'LineWidth',obj.lw,'Color',obj.primaryColor)
            ...
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,5)*R2D,'LineWidth',obj.lw,'Color',obj.primaryColor)
            ...
            xlabel('Time [s]')
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,6)*R2D,'LineWidth',obj.lw,'Color',obj.primaryColor)
            ...
            ylabel('North [m]')
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,7),'LineWidth',obj.lw,'Color',obj.primaryColor)
            ...
            hold on
            ylabel('East [m]')
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,8),'LineWidth',obj.lw,'Color',obj.primaryColor)
            ...
            ylabel('Down [m]')
            xlabel('Time [s]')
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,9),'LineWidth',obj.lw,'Color',obj.primaryColor)
            ...
            title('Euler Angles')
            ylabel('Roll [deg]')
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,10)*R2D,'LineWidth',obj.lw,'Color',obj.primaryColor)
            ...
            hold on
            ylabel('Pitch [deg]')
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,11)*R2D,'LineWidth',obj.lw,'Color',obj.primaryColor)
            ...
            ylabel('Yaw [deg]')
            xlabel('Time [s]')
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,12)*R2D,'LineWidth',obj.lw,'Color',obj.primaryColor)
        ...
        function plotErrors(obj)
            ...
            ylabel('North [m/s]')
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,1) - obj.outputs.estimatedStates.signals.values(timeIdx,1),'LineWidth',obj.lw,'Color',obj.primaryColor)
            ax = gca;
            ax.FontSize = obj.fs;
            ...
            hold on
            ylabel('East [m/s]')
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,2) - obj.outputs.estimatedStates.signals.values(timeIdx,2),'LineWidth',obj.lw,'Color',obj.primaryColor)
            ax = gca;
            ax.FontSize = obj.fs;
            ...
            ylabel('Down [m/s]')
            xlabel('Time [s]')
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,3) - obj.outputs.estimatedStates.signals.values(timeIdx,3),'LineWidth',obj.lw,'Color',obj.primaryColor)
            ax = gca;
            ax.FontSize = obj.fs;
            ...
            ylabel('Roll Rate [deg/s]')
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,4)*R2D - obj.outputs.estimatedStates.signals.values(timeIdx,4)*R2D,'LineWidth',obj.lw,'Color',obj.primaryColor)
            ax = gca;
            ax.FontSize = obj.fs;
            ...
            hold on
            ylabel('Pitch Rate [deg/s]')
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,5)*R2D - obj.outputs.estimatedStates.signals.values(timeIdx,5)*R2D,'LineWidth',obj.lw,'Color',obj.primaryColor)
            ax = gca;
            ax.FontSize = obj.fs;
            ...
            ylabel('Yaw Rate [deg/s]')
            xlabel('Time [s]')
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,6)*R2D - obj.outputs.estimatedStates.signals.values(timeIdx,6)*R2D,'LineWidth',obj.lw,'Color',obj.primaryColor)
            ax = gca;
            ax.FontSize = obj.fs;
            ...
            ylabel('North [m]')
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,7) - obj.outputs.estimatedStates.signals.values(timeIdx,7),'LineWidth',obj.lw,'Color',obj.primaryColor)
            ax = gca;
            ax.FontSize = obj.fs;
            ...
            hold on
            ylabel('East [m]')
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,8) - obj.outputs.estimatedStates.signals.values(timeIdx,8),'LineWidth',obj.lw,'Color',obj.primaryColor)
            ax = gca;
            ax.FontSize = obj.fs;
            ...
            ylabel('Down [m]')
            xlabel('Time [s]')
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,9) - obj.outputs.estimatedStates.signals.values(timeIdx,9),'LineWidth',obj.lw,'Color',obj.primaryColor)
            ax = gca;
            ax.FontSize = obj.fs;
            ...
            ylabel('Roll [deg]')
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,10)*R2D - obj.outputs.estimatedStates.signals.values(timeIdx,10)*R2D,'LineWidth',obj.lw,'Color',obj.primaryColor)
            ax = gca;
            ax.FontSize = obj.fs;
            ...
            hold on
            ylabel('Pitch [deg]')
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,11)*R2D - obj.outputs.estimatedStates.signals.values(timeIdx,11)*R2D,'LineWidth',obj.lw,'Color',obj.primaryColor)
            ax = gca;
            ax.FontSize = obj.fs;
            ...
            ylabel('Yaw [deg]')
            xlabel('Time [s]')
            plot(obj.measUpdateTime ,obj.outputs.rcvrStates(obj.timeIdx,12)*R2D - obj.outputs.estimatedStates.signals.values(timeIdx,12)*R2D,'LineWidth',obj.lw,'Color',obj.primaryColor)
            ax = gca;
            ax.FontSize = obj.fs;
        end
