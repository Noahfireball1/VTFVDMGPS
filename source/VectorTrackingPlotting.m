classdef VectorTrackingPlotting < handle
    ...
    methods
        ...
        function plotStates(obj)
            ...
            ylabel('North [m/s]')
            plot(obj.timeVector,obj.outputs.rcvrStates(:,1),'LineWidth',1,'Color',obj.primaryColor)
            ...
            hold on
            ylabel('East [m/s]')
            plot(obj.timeVector,obj.outputs.rcvrStates(:,2),'LineWidth',1,'Color',obj.primaryColor)
            ...
            ylabel('Down [m/s]')
            xlabel('Time [s]')
            plot(obj.timeVector,obj.outputs.rcvrStates(:,3),'LineWidth',1,'Color',obj.primaryColor)
            ...
            plot(obj.timeVector,obj.outputs.rcvrStates(:,4)*R2D,'LineWidth',1,'Color',obj.primaryColor)
            ...
            plot(obj.timeVector,obj.outputs.rcvrStates(:,5)*R2D,'LineWidth',1,'Color',obj.primaryColor)
            ...
            xlabel('Time [s]')
            plot(obj.timeVector,obj.outputs.rcvrStates(:,6)*R2D,'LineWidth',1,'Color',obj.primaryColor)
            ...
            ylabel('North [m]')
            plot(obj.timeVector,obj.outputs.rcvrStates(:,7),'LineWidth',1,'Color',obj.primaryColor)
            ...
            hold on
            ylabel('East [m]')
            plot(obj.timeVector,obj.outputs.rcvrStates(:,8),'LineWidth',1,'Color',obj.primaryColor)
            ...
            ylabel('Down [m]')
            xlabel('Time [s]')
            plot(obj.timeVector,obj.outputs.rcvrStates(:,9),'LineWidth',1,'Color',obj.primaryColor)
            ...
            title('Euler Angles')
            ylabel('Roll [deg]')
            plot(obj.timeVector,obj.outputs.rcvrStates(:,10)*R2D,'LineWidth',1,'Color',obj.primaryColor)
            ...
            hold on
            ylabel('Pitch [deg]')
            plot(obj.timeVector,obj.outputs.rcvrStates(:,11)*R2D,'LineWidth',1,'Color',obj.primaryColor)
            ...
            ylabel('Yaw [deg]')
            xlabel('Time [s]')
            plot(obj.timeVector,obj.outputs.rcvrStates(:,12)*R2D,'LineWidth',1,'Color',obj.primaryColor)
