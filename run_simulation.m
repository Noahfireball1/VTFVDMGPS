...
save(append(dir.output,'Half_MC_100_45db_results.mat'),"run","-v7.3")
...
save(append(dir.output,'Half_MC_100_35db_results.mat'),"run","-v7.3")
...
save(append(dir.output,'Half_MC_100_25db_results.mat'),"run","-v7.3")
...
save(append(dir.output,'Half_MC_100_20db_results.mat'),"run","-v7.3")

clear run
%% 15 db MC
% Initializing Simulation
[model,dir] = initializeSim('C:\Users\nsm0014\graduate\thesis\VTFVDMGPS\config\MC_100_15db.yaml',dir);
% Starting Simulation
printText(7);
run = parsim(model);

save(append(dir.output,'Half_MC_100_15db_results.mat'),"run","-v7.3")

clear run
%% 10 db MC
% Initializing Simulation
[model,dir] = initializeSim('C:\Users\nsm0014\graduate\thesis\VTFVDMGPS\config\MC_100_10db.yaml',dir);
% Starting Simulation
printText(7);
run = parsim(model);

save(append(dir.output,'Half_MC_100_10db_results.mat'),"run","-v7.3")

clear run
%% 5 db MC
% Initializing Simulation
[model,dir] = initializeSim('C:\Users\nsm0014\graduate\thesis\VTFVDMGPS\config\MC_100_5db.yaml',dir);
% Starting Simulation
printText(7);
run = parsim(model);

save(append(dir.output,'Half_MC_100_5db_results.mat'),"run","-v7.3")

clear run
%% 2 db MC
% Initializing Simulation
[model,dir] = initializeSim('C:\Users\nsm0014\graduate\thesis\VTFVDMGPS\config\MC_100_2db.yaml',dir);
% Starting Simulation
printText(7);
run = parsim(model);

save(append(dir.output,'Half_MC_100_2db_results.mat'),"run","-v7.3")
